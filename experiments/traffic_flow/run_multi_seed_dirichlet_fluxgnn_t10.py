"""
交通流 (Dirichlet边界) - FluxGNN_1D (t10) 多随机种子实验

基于 run_ablation_boundary_fluxgnn_t10.py 的配置，使用20个随机种子
...
def main():
    ...
    # 路径配置
    # ========================================================================
    save_path = "FluxNet/results/traffic_flow/multi_seed_boundary_fluxgnn"
