"""
交通流 (Dirichlet边界) - FluxGNN_D_1D (t10) 多随机种子实验

基于 run_ablation_boundary_fluxgnn_d_t10.py 的配置，使用20个随机种子
结果目录结构: save_path/RandomSeed{seed}/FluxGNN_D_1D_pf/
"""
...
SELECTED_MODELS = ['FluxGNN_D_1D_pf']
...
def main():
    ...
    # 路径配置
    # ========================================================================
    save_path = "FluxNet/results/traffic_flow/multi_seed_boundary_fluxgnn_fluxnet"
