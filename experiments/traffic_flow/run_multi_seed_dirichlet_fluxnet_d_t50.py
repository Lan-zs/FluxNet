"""
交通流 (Dirichlet边界) - FluxNet_D_Dirichlet_1D (t50, ns=15) 多随机种子实验

基于 run_ablation_boundary_fluxnet_d_t50.py 的配置，使用20个随机种子
...
def main():
    ...
    # 路径配置 (s1t50数据集)
    # ========================================================================
    save_path = "FluxNet/results/traffic_flow/multi_seed_boundary_ghost_identity_s1t50_ns15"
